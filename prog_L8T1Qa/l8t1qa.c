...
int main( int argc, char *argv[] )
{
	...
	GDALDatasetH hDO1 = GDALCreateCopy(hDr4,L8B1,hD4,FALSE,NULL,NULL,NULL);
	GDALDatasetH hDO2 = GDALCreateCopy(hDr4,L8B2,hD4,FALSE,NULL,NULL,NULL);
	GDALDatasetH hDO3 = GDALCreateCopy(hDr4,L8B3,hD4,FALSE,NULL,NULL,NULL);
	GDALDatasetH hDO4 = GDALCreateCopy(hDr4,L8B4,hD4,FALSE,NULL,NULL,NULL);
	GDALDatasetH hDO5 = GDALCreateCopy(hDr4,L8B5,hD4,FALSE,NULL,NULL,NULL);
	GDALDatasetH hDO6 = GDALCreateCopy(hDr4,L8B6,hD4,FALSE,NULL,NULL,NULL);
	GDALDatasetH hDO7 = GDALCreateCopy(hDr4,L8B7,hD4,FALSE,NULL,NULL,NULL);
